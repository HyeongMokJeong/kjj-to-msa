...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedMethod(HttpMethod.GET); // 모든 method(post, get, put, delete, patch) 허용
        config.addAllowedMethod(HttpMethod.POST); // 모든 method(post, get, put, delete, patch) 허용
